...
ALTER SERVICE IRINFO_RAG.SIS_APP.PDF_TO_IMAGE_SVC START;

-- Optional stop
-- ALTER SERVICE IRINFO_RAG.SIS_APP.PDF_TO_IMAGE_SVC STOP;

-- Refresh stage and list outputs
ALTER STAGE IRINFO_RAG.RAW.IR_STAGE REFRESH;
SELECT RELATIVE_PATH, SIZE, LAST_MODIFIED
FROM DIRECTORY(@IRINFO_RAG.RAW.IR_STAGE)
WHERE RELATIVE_PATH ILIKE 'output_image2/%'
